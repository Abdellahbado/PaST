...
def _repo_root() -> Path:
    # This file lives at PaST/sandbox/run_test.py
...
def _oracle_one_step(
    ...
    from sandbox.neurols.action_space import ActionType
...
def run_variant(
    ...
    *,
    ...
    action_space_override: Optional[str] = None,
    verbose: bool = False,
) -> Dict[str, Any]:
    ...
    action_space_name = (
        str(action_space_override)
        if action_space_override is not None
        else str(cfg.get("action_space", "AANP"))
    )
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Action space override (e.g. STRUCTURE_AWARE).",
    )
    parser.add_argument(
        "--verbose",
        "-v",
    ...
    for key in args.variants:
        ...
        res = run_variant(
            ...
            action_space_override=args.action_space,
