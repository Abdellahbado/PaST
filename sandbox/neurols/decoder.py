...
if _TORCH_AVAILABLE:
    ...
    class NeuroLSPolicy(nn.Module):
        ...
        def __init__(
            ...
            from sandbox.neurols.price_embedding import PriceEmbedding
            ...
            if graph_type == "tripartite":
                from sandbox.neurols.gnn_encoder import TripartiteNeuroLSEncoder
                ...
                from sandbox.neurols.gnn_encoder import NeuroLSEncoder
