...
from sandbox.neurols.operators import OperatorID, OPERATORS
    ...
    def get_action_name(self, action: int) -> str:
        ...
        if decoded.action_type == ActionType.OPERATOR:
            if decoded.operator_id is not None:
                from sandbox.neurols.operators import OPERATOR_BY_ID
            ...
            from sandbox.neurols.perturbations import PERTURBATION_BY_ID
...
STRUCTURE_AWARE_SPACE = ActionSpace(
    ...
    operators=[
        ...
        OperatorID.SWAP_1,
        OperatorID.BLOCK_RELOCATE,
        OperatorID.EVACUATE_PEAK,
        OperatorID.SWAP_PEAK_VALLEY,
    ],
    perturbations=[
        PerturbationID.NONE,
        PerturbationID.SHAKE_SMALL,
