...
Example:
    python -m PaST.cli.experiments.run_experiments --variants all --seeds 0 1 2 --config configs/a100_full.yaml \
    --output_dir runs_a100 --eval_seed 1337 --eval_seed_mode per_update

Parallel (2 GPUs):
    python -m PaST.cli.experiments.run_experiments --variants all --seeds 0 1 --config configs/a100_full.yaml \
