"""
EAS Evaluation Script for ppo_family_q4_beststart variant.
...
- Best-start family decoding

Example:
    python PaST/run_eval_eas_family_q4_beststart.py \\
        --checkpoint PaST/runs_p100/ppo_family_q4_beststart/checkpoints/best.pt \\
...
# =============================================================================
# Utility Functions (same as ppo_short_base version)
# =============================================================================
...
def run_evaluation(
    ...
    print("\n" + "=" * 70)
    print(f"EAS EVALUATION (family_q4_beststart) - {args.method.upper()}")
    ...
    out_csv = out_dir / f"eas_family_q4_beststart_{scale_str}_seed{args.eval_seed}.csv"
    ...
    # Plot results
    plot_results(df, out_dir, scale_str, args.eval_seed, "family_q4_beststart")
